...
public interface OrderDAO {
    ...
    //根据时间段 查询预约中的房型数量
    Integer getOrderChildCountByRoomTypeIdByTime(@Param("roomTypeId") Integer roomId,@Param("endTime")Date endTime,@Param("startTime")Date startTime,@Param("orderId")Integer orderId,@Param("hotelId")Integer hotelId);
    //根据时间段 房型id 查询可入住的数量
