package com.szq.hotel.web.controller.base;

import com.google.common.collect.Lists;
import com.szq.hotel.common.constants.SysConstants;
import com.szq.hotel.entity.bo.AdminBO;
import com.szq.hotel.query.PageObject;
...
//import com.szq.hotel.util.RedisUtil;
...
//        RedisUtil.del(key) ;
    ...
    private void putSession (String key , Object value) {
        RedissonHandler.getInstance().set(key , value , 86400L);
//        RedisUtil.set(value , key) ;
    }
