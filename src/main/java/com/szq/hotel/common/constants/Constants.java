...
public enum Constants {
    ...
    /* 订单状态:已完成 */ACCOMPLISH("accomplish"),
    ...
    /* 项目 : 商品 */ COMMODITY("商品"),
    /* 项目 : 赔偿 */ COMPENSATE("赔偿"),
    /* 项目 : 房费减免 */ ROOMRATEFREE("房费冲减"),
    /* 项目 : 商品减免 */ COMMODITYFREE("商品冲减"),
    /* 项目 : 赔偿减免 */  COMPENSATIONFREE("赔偿冲减"),
    /* 项目 : 超时费减免 */ MITIGATE("超时费冲减"),
    /* 项目 : 房费调整 */ ADJUSTMENT("房费调整"),
    /* 项目 : 超时费 */ TIMEOUTCOST("超时费"),
    /* 项目 : 结账 */ SETTLE("结账"),
